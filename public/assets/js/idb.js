...
// establish connection to IndexedDB database called 'pizza_hunt' an set it to version 1
...
request.onsuccess = function (event) {
  ...
  // check if app is online, if yes run uploadPizza() function to send all local db data to the api
  if (navigator.onLine) {
...
function saveRecord(record) {
  ...
  // access the object to store for `new_pizza`
